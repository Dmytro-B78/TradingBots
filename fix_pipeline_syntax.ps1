# ============================================
# File: fix_pipeline_syntax.ps1
# Purpose: Удалить ошибочную \n-вставку и вставить фильтрацию как отдельную строку
# ============================================
...
Write-Host "=== Исправление pipeline.py ==="
...
if ($inserted) {
    ...
    Write-Host "✅ pipeline.py исправлен: фильтрация вставлена корректно"
} else {
