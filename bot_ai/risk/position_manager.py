# -*- coding: utf-8 -*-
# ============================================
# File: bot_ai/risk/position_manager.py
# Назначение: Управление открытой позицией, SL/TP, трейлинг, частичный выход
# ============================================
...
class PositionManager:
    ...
    def open(self, symbol, side, entry, sl, tp1, tp2, qty, strategy,
             trailing_sl=None, partial_pct=0.5, move_sl_to_be=True):
    ...
    def check_exit(self, current_price):
        ...
        if exit_reason:
            ...
            if side == "short":
                pnl_pct *= -1
            pnl_usdt = round((pnl_pct / 100) * self.active_position["qty"] * entry, 2)
